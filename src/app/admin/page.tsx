...
import { dropdownOptions, rowHeaders, tabOptions, tableHeader } from "@/lib/constants/options";
...
export default function ItemRequestsPage() {
  ...
  const handleDropdownChange = async (
    ...
    try {
      ...
      const localRowStatus: EditStatusRequest[] = updateRowStatus(rowStatus, requestId, newStatus);
  ...
  return (
    ...
    <div className="overflow-x-auto w-full max-w-[1205px] absolute top-[10%] left-[10%] rounded-[8px] border-[1px] border-[#EAECF0] ">
      <TableHeader 
        text= {tableHeader} 
      />
